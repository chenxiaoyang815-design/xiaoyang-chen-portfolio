      ...
      deliveryProof: {
        ...
        items: [
          ...
          },
          {
            ...
            label: "02 · PRODUCT LISTING",
            status: "Listed",
            title: "Road Map Widget is listed and searchable in Atlassian Home",
            caption:
              "The production widget is listed in the Marketplace widget directory inside home.atlassian.com and can be found and added through the Home dashboard flow.",
            alt: "Atlassian Home add-widget screen showing Road Map Widget in the Marketplace tab",
            position: "center 31%",
          },
          {
            image: "project-evidence/atlassian-home-widget-live.png",
            label: "03 · LIVE PRODUCT",
            status: "Running",
            title: "Road Map Widget runs with Jira release data inside Atlassian Home",
            caption:
              "The live Home dashboard renders authorised Jira releases, overdue status, issue counts and calculated progress in the production widget.",
            alt: "Atlassian Home dashboard at home.atlassian.com showing the Road Map Widget running with Jira release names, overdue dates, issue counts and progress bars",
            position: "center 48%",
          },
        ],
      },
      ...
      deliveryProof: {
        ...
        items: [
          ...
          },
          {
            ...
            label: "02 · 产品上架",
            status: "已上架",
            title: "Road Map Widget 已在 Atlassian Home 上架并可检索",
            caption:
              "生产版本已上架至 home.atlassian.com 内的 Marketplace 小工具目录，用户可在 Home Dashboard 的添加流程中检索并添加。",
          ...
          },
          {
            ...
            label: "03 · 生产运行",
            status: "运行中",
            title: "Road Map Widget 已在 Atlassian Home 中读取并展示 Jira 版本数据",
            caption:
              "Home Dashboard 中的生产组件能够呈现经过授权的 Jira 版本、逾期状态、工作项数量和计算后的完成进度。",
            alt: "home.atlassian.com 的 Atlassian Home 仪表板，其中 Road Map Widget 显示 Jira 版本名称、逾期日期、工作项数量和进度条",
            position: "center 48%",
          },
        ],
      },
